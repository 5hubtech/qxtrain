...
from op_qxtrain import util

from .aliases import PathOrStr
from .config import BaseConfig, ShardedCheckpointerType, TrainConfig
from .exceptions import qxtrainCheckpointError
            ...
            with ThreadPoolExecutor(max_workers=self.thread_count) as executor:
                ...
                for f in as_completed(futures):
                    try:
                        ...
                        raise qxtrainCheckpointError(f"Original error:\n{traceback.format_exc()}")
        return fut
...
class qxtrainCoreCheckpointer(Checkpointer):
    def save_checkpoint(
        self,
        dir: PathOrStr,
        fsdp_model: FSDP,
        ...
        *,
        ...
        from qxtrain_core.distributed.checkpoint import (  # type: ignore
...
def build_sharded_checkpointer(
    ...
    elif name == ShardedCheckpointerType.qxtrain_core:
        return qxtrainCoreCheckpointer(cfg)
    else:
