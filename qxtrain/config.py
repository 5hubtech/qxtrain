...
class BaseConfig:
    ...
    def new(cls: Type[C], **kwargs) -> C:
        ...
        try:
            ...
            raise qxtrainConfigurationError(str(e))
...
class FSDPWrapStrategy(StrEnum):
    by_block = "by_block"
    """
    Wrap each qxtrain block with its own FSDP instance.
    """
...
class TrainConfig(BaseConfig):
    """
    qxtrain training configuration.
    """
