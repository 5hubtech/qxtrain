...
def build_memmap_dataset(
    ...
    if data_config.paths:
        if data_config.datasets:
            raise qxtrainConfigurationError("DataConfig.paths is mutually exclusive with DataConfig.datasets")
        ...
        raise qxtrainConfigurationError("One of DataConfig.paths or DataConfig.datasets is required")
