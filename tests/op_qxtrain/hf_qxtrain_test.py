...
def test_auto_hf_classes(model_path: str):
    ...
    from op_qxtrain import OLMoConfig, OLMoForCausalLM, OLMoTokenizerFast
    from op_qxtrain.convert_qxtrain_to_hf import write_config, write_model, write_tokenizer
...
def test_forward(
    ...
    from op_qxtrain import OLMoConfig, OLMoForCausalLM
