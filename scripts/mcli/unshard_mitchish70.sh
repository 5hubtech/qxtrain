...
remote_sharded_checkpoint=$(python -c "from qxtrain.util import find_latest_checkpoint; print(find_latest_checkpoint('s3://ai2-llm/checkpoints/qxtrain-large/mitchish70-002'))")
