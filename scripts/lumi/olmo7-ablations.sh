#!/bin/bash
#SBATCH --job-name=qxtrain7-ablation
...
export qxtrain_CONTAINER=llm-lumi-torch21_latest.sif
...
export DATA_PATH=$FLASH_DIR/preprocessed/qxtrain-mix
...
srun \
  ...
  scripts/run_with_environment.sh \
    ...
    $PROJECT_DIR/containers/$qxtrain_CONTAINER \
    python scripts/train.py configs/qxtrain7-ablation.yaml ${@} \
