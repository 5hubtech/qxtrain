...
from op_qxtrain.checkpoint import (
    Checkpointer,
    LocalShardedCheckpointer,
    qxtrainCoreCheckpointer,
    TorchLegacyShardedCheckpointer,
)
from op_qxtrain.config import ShardedCheckpointerType, TrainConfig
from op_qxtrain.safetensors_util import state_dict_to_safetensors_file
...
def main(
    ...
    elif sharded_checkpoint_type == ShardedCheckpointerType.qxtrain_core:
        checkpointer = qxtrainCoreCheckpointer(config)
    else:
