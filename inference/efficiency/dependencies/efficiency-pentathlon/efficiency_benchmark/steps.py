...
from hf_qxtrain import *

qxtrain_checkpoint = "/net/nfs.cirrascale/allennlp/akshitab/qxtrain-models/qxtrain-1b/"
tokenizer = qxtrainTokenizerFast.from_pretrained(qxtrain_checkpoint)
