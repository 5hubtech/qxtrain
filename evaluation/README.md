...
The catwalk code exists [here](https://github.com/allenai/catwalk/tree/qxtrain-eval).
...
* Share the google sheet with `qxtrain-eval@ai2-allennlp.iam.gserviceaccount.com`.
...
1. See examples [here](https://github.com/allenai/catwalk/tree/qxtrain-eval/catwalk/tasks).
2. Add newly created tasks to [TASKS_LM](https://github.com/allenai/catwalk/blob/qxtrain-eval/catwalk/tasks/tasks_lm.py)
 or [TASKS](https://github.com/allenai/catwalk/blob/qxtrain-eval/catwalk/tasks/__init__.py).