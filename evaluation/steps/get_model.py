...
from hf_qxtrain.add_hf_config_to_qxtrain_checkpoint import (
...
def get_model_path(
    ...
    # TODO: ugly. fix. Ideally, the model_path already has HF-qxtrain model.
    if "qxtrain" in str(model_path):
        try:
